...
class CloudRunnerOptions {
	...
	static get githubOwner(): string {
		return (
			CloudRunnerOptions.getInput("githubOwner") ||
	...
	static get githubRepoName(): string {
		return (
			CloudRunnerOptions.getInput("githubRepoName") ||
	...
	static get githubRepo(): string | undefined {
		return (
			CloudRunnerOptions.getInput("GITHUB_REPOSITORY") ||
	...
	static get branch(): string {
		if (CloudRunnerOptions.getInput(`GITHUB_REF`)) {
			return (
				CloudRunnerOptions.getInput(`GITHUB_REF`)
					?.replace("refs/", "")
					.replace(`head/`, "")
					.replace(`heads/`, "") || ``
			);
	...
	static get providerStrategy(): string {
		const provider =
			CloudRunnerOptions.getInput("cloudRunnerCluster") ||
	...
	static get useSpotInstances(): boolean {
	...
	static get awsCloudFormationEndpoint(): string | undefined {
		return (
			CloudRunnerOptions.getInput("awsCloudFormationEndpoint") ||
	...
	static get awsEcsEndpoint(): string | undefined {
		return (
			CloudRunnerOptions.getInput("awsEcsEndpoint") ||
			CloudRunnerOptions.awsEndpoint
		);
	}
	...
	static get awsKinesisEndpoint(): string | undefined {
		return (
			CloudRunnerOptions.getInput("awsKinesisEndpoint") ||
			CloudRunnerOptions.awsEndpoint
		);
	}
	...
	static get awsCloudWatchLogsEndpoint(): string | undefined {
		return (
			CloudRunnerOptions.getInput("awsCloudWatchLogsEndpoint") ||
			CloudRunnerOptions.awsEndpoint
		);
	}
	...
	static get awsS3Endpoint(): string | undefined {
		return (
			CloudRunnerOptions.getInput("awsS3Endpoint") ||
			CloudRunnerOptions.awsEndpoint
		);
	}
